-- UNRE EXTENDED DATABASE SCHEMA - STEP BY STEP VERSION
-- Run this if you encounter errors with the main extended-database-schema.sql
-- You can run this entire file, or run each section separately

-- ============================================
-- PART 1: ADD NEW USER ROLES
-- ============================================
-- If you get "already exists" errors, that's fine - skip to next section
...
BEGIN
  ...
  RAISE NOTICE '✅ Total new tables: 16';
  RAISE NOTICE '✅ All indexes, RLS policies, and functions created';
END $$;
